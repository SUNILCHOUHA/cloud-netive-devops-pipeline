...
├── docs/                     # Architecture diagrams and related docs
...
Contains architecture diagrams and documentation assets.
...
AlwaysFiring Alert
Used to validate the full alert pipeline and ensure Slack integration works correctly.
High CPU Alert
Used to detect workloads or resources consuming high CPU.
Pod Restart Alert
Used to identify unstable workloads or crash/restart scenarios.
